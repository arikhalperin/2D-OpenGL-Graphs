...
public class LineScreenBuffer extends ScreenBuffer {
	...
	LineScreenBuffer(int samplesInScreen, float startX, float startY,
	...
	void drawScreenBuffer(GL10 gl) {
		...
		//Draw Left Side(From read pointer to end of buffer)
		...
		gl.glDrawArrays(GL10.GL_LINES, 0, (mSamplesInScreen-readPointer-1)*2);
		...
		{	
			...
			gl.glDrawArrays(GL10.GL_LINES, 0, readPointer*2);
	...
	void dumpBuffer()
	{
		...
		{
			Log.i("BD",""+i+":"+mFVertexBuffer.get(current));
